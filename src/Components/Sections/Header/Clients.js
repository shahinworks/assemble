  ...
  return (
    <>
        <Row style={{paddingTop: "100px", marginTop: "30px"}}>
            ...
            <Row>
            <h4 style={{fontSize: "20px", fontWeight: "bold", fontFamily: "raleway"}} className='mx-4 text-left'>UNIQUE & UNISEX</h4>
        ...
        <Col className='col-lg-6 col-md-6 col-sm-12  justify-content-center'>
            ...
            <Row>
            <h4 style={{fontSize: "20px", fontWeight: "bold", fontFamily: "raleway"}} className='mx-4 text-left'>#BEDRESSPONSIBLE</h4>
